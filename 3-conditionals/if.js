...
/*
3 - Write a statement that assigns the value of the addition of the 'first' & 'second'
    variables to a new variable called 'third' IF first is greater than 'second'.
